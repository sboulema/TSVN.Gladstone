...
internal class ApplyPatchToolbarCommand : Command
{
    private readonly CommandHelper _commandHelper;
    private readonly FileHelper _fileHelper;

    public ApplyPatchToolbarCommand(VisualStudioExtensibility extensibility,
    ...
    /// <inheritdoc />
    public override CommandConfiguration CommandConfiguration => new("%TSVN.ApplyPatchToolbarCommand.DisplayName%")
    {
